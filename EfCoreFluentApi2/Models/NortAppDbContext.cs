using EfCoreFluentApi2.Mapping;
...
namespace EfCoreFluentApi2.Models
{
    ...
    public class NortAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Yöntem2
            // FluentApi yönteminde mapping sınıfları oluşturularak eşleştirme yapılabilir. Bu yöntem OnModelCreating metodun kod kalabalığını azaltmak için kullanılır...
